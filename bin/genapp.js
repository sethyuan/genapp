...
/*** Generated by streamline 0.4.0 (callbacks) - DO NOT EDIT ***/ var __rt=require('streamline/lib/callbacks/runtime').runtime(__filename),__func=__rt.__func,__cb=__rt.__cb,__trap=__rt.__trap,__tryCatch=__rt.__tryCatch,__forIn=__rt.__forIn; (function __1(_) { var fgen, fs, fs_, path, readline, nomnom, argv, options, configFile, bundles, bundle, contextFolder, subroot, contextFile, context, question, constructContext, rl, realContext, k, gen; var __frame = { name: "__1", line: 1 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() {
    ...
    return fs_.exists(configFile, __cb(_, __frame, 54, 4, function ___A(__0, __6) { return (function __$__1(__then) { if (__6) {
        ...
        bundles = { };
        return options.roots.forEach_(__cb(_, __frame, 65, 0, function __$__1() {
          ...
          return fs_.exists(contextFolder, __cb(_, __frame, 97, 5, function ___A(__0, __9) { var __8 = !__9; return (function __$__1(__then) { if (__8) {
                console.log("Bundle '%s' does not exist in root '%s'.", argv._.join(" "), bundles[bundle]);

                process.exit(1); __then(); } else { __then(); } ; })(function __$__1() { return (function __$__1(__then) {


                if (argv.list) {
                  subroot = path.join(contextFolder, "___");
                  return fs_.exists(subroot, __cb(_, __frame, 105, 6, function ___A(__0, __10) { return (function __$__1(__then) { if (__10) {
                        return fs.readdir(subroot, __cb(_, __frame, 106, 4, function ___A(__0, __11) {
                          return __11.filter_(__cb(_, __frame, 107, 4, function ___A(__0, __12) { __12.forEach(function(folder) {
                              ...
                              console.log(folder); }); __then(); }, true), -1, function __2(_, file) { var __frame = { name: "__2", line: 108 }; return __func(_, this, arguments, __2, 0, __frame, function __$__2() { return fs.stat(path.join(subroot, file), __cb(_, __frame, 1, 15, function ___A(__0, __2) { var __1 = __2.isDirectory(); return _(null, __1); }, true)); }); }); }, true)); } else { __then(); } ; })(function __$__1() {


                      console.log();
                      process.exit(0); __then(); }); }, true)); } else { __then(); } ; })(function __$__1() {


                contextFile = path.join(contextFolder, "..", (argv._[(argv._.length - 1)] + ".js")); return (function ___A(__then) { (function ___A(_) { __tryCatch(_, function __$__1() {



                      context = require(contextFile); __then(); }); })(function ___A(e, __result) { __tryCatch(_, function __$__1() { if (e) {

                        console.log("Cannot read bundle '%s' context file.\n\n%s", argv._.join("/___/"), e);

                        process.exit(1); __then(); } else { _(null, __result); } ; }); }); })(function ___A() { __tryCatch(_, function __$__1() {
                                    ...
                                    var __3 = __forIn(val); var __4 = 0; return (function ___A(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$constructContext__3() { __more = false; var __11 = (__4 < __3.length); if (__11) { k = __3[__4++];
                                      ...
                                      if ((val != null)) { return (function __$constructContext__3(__break) {
                                          ...
                                          case "boolean": return question(((prefix + key) + "? (yes/no) "), __cb(_, __frame, 44, 19, function ___A(__0, __7) {
                                              answer = __7.toLowerCase(); return (function __$constructContext__3(__then) { if ((answer === "yes")) {
                                                  ctx[key] = true;
                                                  __then(); } else { return (function __$constructContext__3(__then) { if ((answer === "no")) {
                                                      ctx[key] = false;
                    ...
                    realContext = { };
                    var __4 = __forIn(context.context); var __5 = 0; return (function ___A(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$__1() { __more = false; var __21 = (__5 < __4.length); if (__21) { k = __4[__5++];
                          return constructContext(k, context.context[k], realContext, "", __cb(_, __frame, 198, 2, function __$__1() { while (__more) { __loop(); }; __more = true; }, true)); } else { __break(); } ; }); do { __loop(); } while (__more); __more = true; })(function __$__1() {

                      rl.close(); return (function __$__1(__then) {
                        if ((typeof context.postProcess === "function")) {
                          return context.postProcess(realContext, __cb(_, __frame, 202, 2, __then, true)); } else { __then(); } ; })(function __$__1() { return (function ___A(__then) { (function ___A(_) { __tryCatch(_, function __$__1() {
                              ...
                              return fgen.createGenerator(contextFolder, __cb(_, __frame, 205, 12, function ___A(__0, __13) { gen = __13;
                                ...
                                return gen.generateAll(argv.output, function(k) {
                                  return !/^___(\/|\\)/.test(k); }, __cb(_, __frame, 207, 2, function __$__1() {

                                  console.log("done."); __then(); }, true)); }, true)); }); })(function ___A(e, __result) { __tryCatch(_, function __$__1() { if (e) {
