#!/usr/bin/env node
/*** Generated by streamline 0.4.7 (callbacks) - DO NOT EDIT ***/ var __rt=require('streamline/lib/callbacks/runtime').runtime(__filename),__func=__rt.__func,__cb=__rt.__cb,__trap=__rt.__trap,__tryCatch=__rt.__tryCatch,__forIn=__rt.__forIn; (function main(_) { var fgen, fs, fs_, path, readline, nomnom, argv, options, configFile, bundles, bundle, contextFolder, contextFile, context, question, constructContext, rl, realContext, k, gen; var __frame = { name: "main", line: 1 }; return __func(_, this, arguments, main, 0, __frame, function __$main() {
    ...
    return fs_.exists(configFile, __cb(_, __frame, 49, 4, function ___(__0, __5) { return (function __$main(__then) { if (__5) {

          return fs.readFile(configFile, "utf8", __cb(_, __frame, 51, 15, function ___(__0, __6) { options.roots = JSON.parse(__6).roots.map(function(root) {
        ...
        bundles = { };
        return options.roots.forEach_(__cb(_, __frame, 60, 0, function __$main() {
          ...
          return fs_.exists(contextFolder, __cb(_, __frame, 92, 5, function ___(__0, __8) { var __7 = !__8; return (function __$main(__then) { if (__7) {
              ...
              contextFile = path.join(contextFolder, "..", (argv._[(argv._.length - 1)] + ".js")); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$main() {
                    ...
                    context = require(contextFile); __then(); }); })(function ___(e, __result) { __tryCatch(_, function __$main() { if (e) {
                  ...
                  constructContext = function constructContext__2(key, val, ctx, prefix, _) { var more, item, k, answer, number; var __frame = { name: "constructContext__2", line: 114 }; return __func(_, this, arguments, constructContext__2, 4, __frame, function __$constructContext__2() { return (function __$constructContext__2(__then) {
                  ...
                  realContext = { };
                  var __3 = __forIn(context.context); var __4 = 0; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$main() { __more = false; var __14 = (__4 < __3.length); if (__14) { k = __3[__4++];
                        return constructContext(k, context.context[k], realContext, "", __cb(_, __frame, 178, 2, function __$main() { while (__more) { __loop(); }; __more = true; }, true)); } else { __break(); } ; }); do { __loop(); } while (__more); __more = true; })(function __$main() {

                    rl.close(); return (function __$main(__then) {
                      if ((typeof context.postProcess === "function")) {
                        return context.postProcess(realContext, __cb(_, __frame, 182, 2, __then, true)); } else { __then(); } ; })(function __$main() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$main() {


                            return fgen.createGenerator(contextFolder, __cb(_, __frame, 185, 12, function ___(__0, __9) { gen = __9;
                              gen.context = realContext;
                              return gen.generateAll(argv.output, function(k) {
                                return !/^___(\/|\\)/.test(k); }, __cb(_, __frame, 187, 2, function __$main() {

                                console.log("done."); __then(); }, true)); }, true)); }); })(function ___(e, __result) { __tryCatch(_, function __$main() { if (e) {

                              console.log();
                              console.log(e.message); __then(); } else { _(null, __result); } ; }); }); })(function ___() { __tryCatch(_, _); }); }); }); }); }); }); }, true)); }, true), function __1(_, root) { var __frame = { name: "__1", line: 61 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() { return fs_.exists(root, __cb(_, __frame, 1, 6, function ___(__0, __2) { return (function __$__1(__then) { if (__2) { return fs.readdir(root, __cb(_, __frame, 2, 11, function ___(__0, __4) { return __4.filter_(__cb(_, __frame, 3, 11, function ___(__0, __5) { var __3 = __5.forEach(function(folder) { if ((!/^__/.test(folder) && !bundles[folder])) { bundles[folder] = root; }; }); return _(null, __3); }, true), -1, function __1(_, file) { var __frame = { name: "__1", line: 64 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() { return fs.stat(path.join(root, file), __cb(_, __frame, 1, 15, function ___(__0, __2) { var __1 = __2.isDirectory(); return _(null, __1); }, true)); }); }); }, true)); } else { __then(); } ; })(_); }, true)); }); }); }); }, true)); });}).call(this, __trap);
