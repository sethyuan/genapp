          ...
          return options.roots.forEach_(__cb(_, __frame, 44, 0, function __$main() {
            ...
            var __7 = !((argv._[0] in bundles)); return (function __$main(__then) { if (__7) {
              ...
              contextFile = path.join(contextFolder, "..", (argv._[(argv._.length - 1)] + ".js")); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$main() {
                  ...
                  constructContext = function constructContext__2(key, val, ctx, prefix, _) { var type, item, more, answer, number; var __frame = { name: "constructContext__2", line: 84 }; return __func(_, this, arguments, constructContext__2, 4, __frame, function __$constructContext__2() {
                          ...
                          rl.once("SIGINT", function() {
                            ...
                            rl.write("\n"); }); return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$constructContext__2() { __more = false;
                              ...
                              var __6 = more; if (__6) {
                                item = { };
                                ctx[key].push(item);
                                return Object.keys(val[0]).forEach_(__cb(_, __frame, 15, 6, function __$constructContext__2() { while (__more) { __loop(); }; __more = true; }, true), function __1(_, k) { var __frame = { name: "__1", line: 99 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() {
                            ...
                            if ((typeof (val) === "function")) {
                              ctx[key] = val; __then(); } else { return (function __$constructContext__2(__then) {
                                if (((typeof (val) === "object") && (val !== null))) {
                                  item = { };
                                  ctx[key] = item;
                                  return Object.keys(val).forEach_(__cb(_, __frame, 25, 4, __then, true), function __2(_, k) { var __frame = { name: "__2", line: 109 }; return __func(_, this, arguments, __2, 0, __frame, function __$__2() {
