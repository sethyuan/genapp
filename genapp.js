...
/*** Generated by streamline 0.4.5 (callbacks) - DO NOT EDIT ***/ var __rt=require('streamline/lib/callbacks/runtime').runtime(__filename),__func=__rt.__func,__cb=__rt.__cb,__trap=__rt.__trap,__tryCatch=__rt.__tryCatch; (function main(_) { var fgen, path, fs, util, readline, optimist, argv, homeDir, configFile, options, userOptions, bundles, gen, rl, contextFolder, contextFile, context, realContext, question, i; var __frame = { name: "main", line: 1 }; return __func(_, this, arguments, main, 0, __frame, function __$main() { fgen = require("fgen");
    ...
    argv = optimist.usage(((("gen bundle [sub [sub...]] [-o DIR]\n\n" + "EXAMPLES:\n") + "gen node\n") + "gen cs class")).alias("o", "output").alias("h", "help").default("o", "./").describe("o", "A destination folder where you want to generate to.").argv;
    bundles = { }; return (function __$main(_) {


      var __4 = argv.h; if (__4) { return _(null, __4); } ; var __5 = ((argv._.length < 1)); return _(null, __5); })(__cb(_, __frame, 0, 21, function ___(__0, __5) { return (function __$main(__then) { if (__5) {
          optimist.showHelp();
        ...
        configFile = path.join(homeDir, ".genappconfig"); return (function __$main(__then) {
          ...
          return options.roots.forEach_(__cb(_, __frame, 44, 0, function __$main() {
            ...
            var __7 = !((argv._[0] in bundles)); return (function __$main(__then) { if (__7) {
              ...
              contextFolder = path.join(bundles[argv._[0]], argv._.join("/___/")); return (function __$main(__then) {
                if (!fs.existsSync(contextFolder)) {
                  console.log("Bundle '%s' does not exist in root '%s'.", argv._.join(" "), bundles[argv._[0]]);
                  process.exit(1); __then(); } else { __then(); } ; })(function __$main() {


                contextFile = path.join(contextFolder, "..", (argv._[(argv._.length - 1)] + ".js")); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$main() {
                    ...
                    constructContext = function constructContext__2(key, val, ctx, prefix, _) { var type, item, more, answer, number; var __frame = { name: "constructContext__2", line: 89 }; return __func(_, this, arguments, constructContext__2, 4, __frame, function __$constructContext__2() {
                            ...
                            rl.once("SIGINT", function() {
                              ...
                              rl.write("\n"); }); return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$constructContext__2() { __more = false;
                                ...
                                var __6 = more; if (__6) {
                                  item = { };
                                  ctx[key].push(item);
                                  return Object.keys(val[0]).forEach_(__cb(_, __frame, 15, 6, function __$constructContext__2() { while (__more) { __loop(); }; __more = true; }, true), function __1(_, k) { var __frame = { name: "__1", line: 104 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() {
                              ...
                              if ((typeof (val) === "function")) {
                                ctx[key] = val; __then(); } else { return (function __$constructContext__2(__then) {
                                  if (((typeof (val) === "object") && (val !== null))) {
                                    item = { };
                                    ctx[key] = item;
                                    return Object.keys(val).forEach_(__cb(_, __frame, 25, 4, __then, true), function __2(_, k) { var __frame = { name: "__2", line: 114 }; return __func(_, this, arguments, __2, 0, __frame, function __$__2() {
                    ...
                    realContext = { };
                    return Object.keys(context.context).forEach_(__cb(_, __frame, 154, 0, function __$main() {


                      rl.close(); return (function __$main(__then) {
                        if (context.postProcess) { return context.postProcess(realContext, __cb(_, __frame, 158, 25, __then, true)); } else { __then(); } ; })(function __$main() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$main() {


                              return fgen.createGenerator(contextFolder, __cb(_, __frame, 161, 8, function ___(__0, __9) { gen = __9;
                                gen.context = realContext;
                                return gen.generateAll(argv.output, function(k) {
                                  return !/^___(\/|\\)/.test(k); }, __cb(_, __frame, 163, 2, function __$main() {

                                  console.log("done."); __then(); }, true)); }, true)); }); })(function ___(e, __result) { __tryCatch(_, function __$main() { if (e) {

                                console.log();
                                console.log(e.message); __then(); } else { _(null, __result); } ; }); }); })(function ___() { __tryCatch(_, _); }); }); }, true), function __3(_, key) { var __frame = { name: "__3", line: 155 }; return __func(_, this, arguments, __3, 0, __frame, function __$__3() { return constructContext(key, context.context[key], realContext, null, __cb(_, __frame, 1, 2, _, true)); }); }); }); }); }); }); }, true), function __1(_, root) { var __frame = { name: "__1", line: 45 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() { if (!fs.existsSync(root)) { return _(null); } ; return fs.readdir(root, __cb(_, __frame, 3, 2, function ___(__0, __2) { return __2.filter_(__cb(_, __frame, 4, 2, function ___(__0, __3) { __3.forEach(function(folder) { if (!((/^__/.test(folder) || ((folder in bundles))))) { bundles[folder] = root; }; }); _(); }, true), -1, function __1(_, file) { var __frame = { name: "__1", line: 49 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() { return fs.stat(path.join(root, file), __cb(_, __frame, 1, 13, function ___(__0, __2) { var __1 = __2.isDirectory(); return _(null, __1); }, true)); }); }); }, true)); }); }); }); }); }, true)); });}).call(this, __trap);
